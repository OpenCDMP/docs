...
There are several cases where users need to provide information in their [Plans](/user-guide/plans/index.md) or [Descriptions](/user-guide/descriptions/index.md) not by typing free text, but by **selecting values from predefined or externally sourced lists**.  
...
[Reference Types Administration](admin-guide/system-configuration/reference-types.md) section of the documentation.
:::
