...
:::info
For administrator configuration details, see [Description Workflow Configuration](/docs/admin-guide/system-configuration/description-workflow.md).
:::
...
All descriptions you have created or are a contributor to are listed on the [My Descriptions](user-guide/descriptions/my-descriptions.md) page, along with their current status.
