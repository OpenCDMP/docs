...
:::info
- The deposit feature is available only on the [Plan Overview](user-guide/plans/plan-overview.md) page.
- Deposit is only available when the current plan status permits it. See [Plan Statuses](admin-guide/system-configuration/plan-statuses.md) for details.
- The deposit repositories available to you depend on which [Deposit Services](optional-services/deposit-services.md) your administrator has configured.
:::
...
| **Use your [Repository] credentials** | Uses credentials you have saved in your [Profile Settings](user-guide/profile-settings.md). Available only if you have configured credentials for this repository. |
...
- [Deposit Services](optional-services/deposit-services.md) — the available repositories and how they are configured
- [Plan Overview](user-guide/plans/plan-overview.md) — where the Deposit button is located
