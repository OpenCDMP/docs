...
:::info
- The evaluation feature is available only on the [Plan Overview](user-guide/plans/plan-overview.md) page.
- Evaluation is only available when the current plan status permits it. See [Plan Statuses](admin-guide/system-configuration/plan-statuses.md) for details.
...
- [Plan Overview](user-guide/plans/plan-overview.md) — where the Evaluate button is located
- [Deposit a Plan](user-guide/plans/deposit-a-plan.md) — required before running the OpenAIRE FAIR evaluator
