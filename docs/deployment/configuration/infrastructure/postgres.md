...
- To apply changes after the database has been initialized, you should use the **database migration mechanism** (see [Database Migrations](deployment/install/upgrade.md#step-4-run-database-migrations-if-needed)).
