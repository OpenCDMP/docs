...
| --mat-sys-primary      | The most common color used by components to participate in the application theme. Also the color associated with [**Plans**](using/plans/index.md). |
| --mat-sys-on-primary   | used for icons, text, and other visual elements placed on a primary background           |
| --mat-sys-tertiary      | The accent color used by components to participate in the application theme. Also the color associated with [**Descriptions**](using/descriptions/index.md). |
