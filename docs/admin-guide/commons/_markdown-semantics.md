...
2. **Prefilling**: When a [Prefilling Source](/docs/admin-guide/system-configuration/prefilling-sources.md) is configured with a matching semantic target, the system knows which description template field to populate with the fetched data.
