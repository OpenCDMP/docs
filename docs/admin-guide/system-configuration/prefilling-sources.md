...
:::note
Prefilling is only available for descriptions in plans where the blueprint explicitly enables it for that section. See [Blueprints](/admin-guide/content-management/blueprints/index.md) for configuration details.
:::
