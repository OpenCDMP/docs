...
On this page, users can provide their own credentials if they prefer not to use the default configuration. This allows greater flexibility when connecting to external services. Click [here](/docs/optional-services/deposit-services/index.md) to view the list of available deposit services.
