...
Not sure what these are? See the [Using OpenCDMP](/using/) overview for how Blueprints, Description Templates, Plans, and Descriptions relate to each other.
:::
...
The plan editor fields are not fixed and depend on the blueprint structure. A blueprint is a plan template that defines what sections and fields appear in your plan. Learn more about [Blueprints](../using/blueprints.md).
:::
...
:::note Blueprint Structure
The availability and fields for contributors and organizations depend on the blueprint structure. Some blueprints may not include these sections or may have different fields. Learn more about [Blueprints](../using/blueprints.md).
:::
...
:::note Blueprint Structure
The availability and fields for funding information depend on the blueprint structure. Some blueprints may not include this section or may have different fields. Learn more about [Blueprints](../using/blueprints.md).
:::
...
:::note Blueprint Structure
The availability and fields for licensing and access rights depend on the blueprint structure. Some blueprints may not include this section or may have different fields. Learn more about [Blueprints](../using/blueprints.md).
:::
...
:::note Plan Status
The availability of review and validation features may depend on the plan status. Some features may only be available in certain plan states (Draft, Finalized, etc.). Learn more about [Plan Workflow](../using/plans/plan-workflow.md).
:::
...
Learn more about [plan workflows](using/plans/plan-workflow.md).
:::
...
Learn more about [inviting collaborators](using/plans/invite-collaborators.md).
...
Learn more about [plan exports](using/plans/exports.md).
...
Learn more about [depositing plans](using/plans/deposit-a-plan.md).
...
2. **Create Versions**: Use [versioning](using/plans/versions.md) to track major changes
3. **Explore Advanced Features**:
   - [Annotations and review](using/plans/reviewing.md)
   - [Plan evaluation](using/plans/evaluators.md)
   - Multiple description templates
4. **Create Plans for Other Projects**: Repeat this process for each research project

### Common Next Actions

- **View your plans**: Go to [My Plans](using/plans/my-plans.md) to see all your plans
...
**Solution**:
- Go to [My Plans](using/plans/my-plans.md)
...
- [Administrator's First Steps](administering/getting-started.md) - For setting up OpenCDMP
- [Common Workflows & Use Cases](deployment/getting-started-workflows.md) - Real-world scenarios
- [Create/Edit a Plan](using/plans/create-or-edit-a-plan.md) - Quick reference
- [Plan Workflow](using/plans/plan-workflow.md) - Understanding plan statuses
- [Inviting Collaborators](using/plans/invite-collaborators.md) - Team collaboration
...
- **Documentation**: Browse the full [User Guide](using/index.md)
