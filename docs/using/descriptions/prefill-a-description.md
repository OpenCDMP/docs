...
:::note
Prefilling is only available when the plan's [blueprint](/docs/using/blueprints.md) has been configured to support it for the relevant section.
:::
...
:::info
You can learn how administrators configure prefilling sources in the [Prefilling Sources](/docs/administering/system-configuration/prefilling-sources.md) section.
:::
