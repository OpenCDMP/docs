...
| **Reference Types** | Linked reference record | Selecting from an external source (grants, organizations, etc.) — connects to a configured [Reference Type](/docs/administering/system-configuration/reference-types.md) |
