...
:::info
Usage limits are quotas that can be set on different entities or resources. These limits are [tenant](administering/tenant-management/tenants.md) specific, meaning you view only the limits set for tenants you manage.
